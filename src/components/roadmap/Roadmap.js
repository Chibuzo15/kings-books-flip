      ...
      <div id="roadmap">
        ...
        <Grid container className="roadmapParas">
          <Grid item xs={12} sm={11} md={10} className="roadmapParaContainer">
            ...
            <div className="roadmapIconBack">
              <Button
                onClick={() => book.current.pageFlip().flipPrev()}
                className={classes.roadmapIconBackBtn}
              >
                <ArrowBackIcon className={classes.roadmapIconBack} />
              </Button>
            </div>
            <div className="roadmapIconForward">
              <Button
                onClick={() => book.current.pageFlip().flipNext()}
                className={classes.roadmapIconBackBtn}
              >
                <ArrowForwardIcon className={classes.roadmapIconForward} />
              </Button>
            </div>
          </Grid>
        </Grid>
